                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
	                  	  	  <h4><i class="fa fa-angle-right"></i> 信息管理</h4>
	                  	  	  <hr>
                              <thead>
                              <tr>
                                  <th><i class="fa fa-bullhorn"></i> 关键字</th>
                                  <th class="hidden-phone"><i class="fa fa-question-circle"></i> 信息类型</th>
                                  <th><i class="fa fa-bookmark"></i> 信息状态</th>
                                  <th><i class=" fa fa-edit"></i> 标题</th>
                                  <th><i class=" fa fa-edit"></i> 时间</th>
                                  <th></th>
                              </tr>
                              </thead>
                              <tbody>
                              ...
                              <tr>
								  <td><a href="basic_table.html#">${thing.tType}</a></td>
                                  <td class="hidden-phone">${thing.mType}</td>
                                  <td>${thing.tState} </td>
                                  <td><span class="label label-info label-mini">${thing.tName}</span></td>
                                  <td>${thing.tTime} </td>
                                  <td>
                                  <button class="btn btn-primary btn-xs" onclick="location='<c:url value='/AdminServlet?method=detail&tid=${thing.tid }'/>'"><i class="fa fa-pencil"></i></button>
                                  <button class="btn btn-danger btn-xs" onclick="location='<c:url value='/AdminServlet?method=deleteThing&tid=${thing.tid }'/>'"><i class="fa fa-trash-o "></i></button>
                                  </td>
                              </tr>                              
								</c:forEach>
                              </tbody>
